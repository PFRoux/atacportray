...
2. **Epigenome branch** (`--run_epigenome`): Bowtie2 alignment, blacklist filtering, peak calling ([`MACS3`](https://github.com/macs3-project/MACS)), consensus peaks, coverage bigWigs ([`deepTools`](https://deeptools.readthedocs.io/)), super-enhancers ([`ROSE`](http://younglab.wi.mit.edu/super_enhancer_code.html)) and optional TF footprinting ([`TOBIAS`](https://github.com/loosolab/TOBIAS))
